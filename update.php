...
{
    global $connection;
    $query = "SELECT * FROM cv_data WHERE id = 0"; // Sesuaikan dengan id CV 
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $query = "UPDATE cv_data SET 
        ...
        keterampilan = ?, 
        foto = ? 
        WHERE id = 0"; // Sesuaikan dengan id CV 

    $stmt = mysqli_prepare($connection, $query);
    mysqli_stmt_bind_param($stmt, "sssssssss", $nama, $alamat, $telepon, $email, $web, $pendidikan, $pengalaman_kerja, $keterampilan, $foto);
            ...
            <div class="card-body">
                <form method="post">
                    <div class="mb-3">
                        ...
                        <input class="form-control" type="text" id="formFile" name="foto" value="<?php echo $data['foto']; ?>" required>
                    </div>
